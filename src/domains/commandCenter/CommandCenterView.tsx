...
import { AICeoAssistant } from '../../ai/assistant/AICeoAssistant';
...
export const CommandCenterView: React.FC<CommandCenterViewProps> = ({
  ...
  return (
    <div className="space-y-8">
      {/* AI CEO Intelligence & Conversational Assistant */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-indigo-900/50 rounded-2xl p-6 shadow-xl space-y-4">
        ...
        {/* AI CEO Conversational Assistant Panel */}
        <AICeoAssistant
